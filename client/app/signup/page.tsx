      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 text-white flex-col justify-between p-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-slate-400 text-lg">
            Join CrisisLens and discover how your investments would weather
            any storm — from market crashes to geopolitical upheaval.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardDescription>Get started with CrisisLens in seconds</CardDescription>
            </CardHeader>
